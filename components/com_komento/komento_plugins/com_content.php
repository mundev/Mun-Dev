...
class KomentoComcontent extends KomentoExtension
{
	...
	public function load($cid)
	{
		...
		if (!isset($instances[$cid])) {
			$db		= KT::db();
			$query	= 'SELECT a.id, a.title, a.alias, a.catid, a.created_by, a.created_by_alias, a.hits, a.state,' //a.attribs
	...
	public function getComponentSettings()
	{
		...
		$obj->type = 'grid.selectlist';
		$obj->values = array(array('value' => 0, 'text' => 'COM_KOMENTO_SETTINGS_LAYOUT_FRONTPAGE_READMORE_ALWAYS_HIDE'),
							array('value' => 1, 'text' => 'COM_KOMENTO_SETTINGS_LAYOUT_FRONTPAGE_READMORE_OBEY_READMORE_BREAK'),
							array('value' => 2, 'text' => 'COM_KOMENTO_SETTINGS_LAYOUT_FRONTPAGE_READMORE_ALWAYS_SHOW'));
		...
		$obj->type = 'grid.selectlist';
		$obj->values = array(array('value' => 'all', 'text' => 'COM_KOMENTO_SETTINGS_PAGEBREAK_LOAD_ALL'),
							array('value' => 'first', 'text' => 'COM_KOMENTO_SETTINGS_PAGEBREAK_LOAD_FIRST'),
							array('value' => 'last', 'text' => 'COM_KOMENTO_SETTINGS_PAGEBREAK_LOAD_LAST'));
		...
		$obj->type = 'grid.selectlist';
		$obj->values = array(array('value' => 'joomla', 'text' => 'COM_KOMENTO_SETTINGS_READMORE_JOOMLA'),
							array('value' => 'komento', 'text' => 'COM_KOMENTO_SETTINGS_READMORE_KOMENTO'));
