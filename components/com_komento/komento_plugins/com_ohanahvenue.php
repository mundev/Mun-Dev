...
class KomentoComOhanahVenue extends KomentoExtension
{
	...
	public function load($cid)
	{
		...
		$cid = !$cid ? JRequest::getInt('ohanah_venue_id') : $cid;
	...
	{
		return (JRequest::getCmd('view') == 'events' && !empty(JRequest::getCmd('ohanah_venue_id')));
	}
	...
	public function onBeforeLoad($eventTrigger, $context, &$article, &$params, &$page, &$options)
	{
		...
		$cid = JRequest::getInt('ohanah_venue_id');
