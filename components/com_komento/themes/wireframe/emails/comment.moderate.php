										  ...
										  <table border="0" cellspacing="0" cellpadding="0">
											<tr>
												<td align="center" style="border-radius: 3px;" bgcolor="#748A94">
													<a href="<?php echo $commentPermalink;?>" target="_blank" style="font-size: 14px; font-family: Helvetica, Arial, sans-serif; color: #ffffff; text-decoration: none; text-decoration: none;border-radius: 3px; padding: 12px 18px; border: 1px solid #748A94; display: inline-block;"><?php echo JText::_('COM_KOMENTO_EMAILS_BUTTON_VIEW_COMMENT');?></a>
												</td>
											</tr>
										  </table>
										</td>
