...
<?php if ($tmpComments) { ?>
	...
	<?php foreach ($tmpComments as $comment) { ?>
		<div class="mod-kt-item <?php echo 'kmt-' . $comment->id; ?>">

			<div class="o-flag">

				<?php if ($params->get('showavatar')) { ?>
					<div class="o-flag__img t-lg-mr--md">
						<a class="o-avatar o-avatar--sm" href="<?php echo $comment->getAuthor()->getPermalink(); ?>">
							<img src="<?php echo $comment->getAuthor()->getAvatar();?>"/>
						</a>
					</div>
				<?php } ?>
