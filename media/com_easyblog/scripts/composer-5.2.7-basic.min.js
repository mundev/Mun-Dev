...
}},reset:function(){}}}),b.resolve()})}),EasyBlog.module("composer/blocks/handlers/image",function(a){function l(a){return a.toString().match("%")?"%":"px"}function m(a,b){var c=Math.pow(10,b);return Math.round(a*c)/c}function n(b){if(a.isNumeric(b))return b;var c=b.toString().split(":");return c[0]+":"+c[1]}function p(a,b){return m(1/n(a)*100,b||3)+"%"}function q(a,b){return m(100*a,b||3)+"%"}function s(a,b){return a.css("width",b)}function t(a,b){return a.css("top",b)}function u(a,b){return a.css("left",b)
...
g.css("height",e);var i=b.getOverlay(h);i.refresh()}},250),"{updateUrl} click":function(){var d=b.url().val(),g=(f.data(h),f.getBlockContent(h));return b.isUrlValid(d)?(b.crawl(d,h),void 0):(b.errorMessage.inside(g).removeClass("hide"),void 0)},"{nocookie} change":function(a){var d=f.data(h);if(d.url){var e=1==a.val()?!0:!1;d.embed=e?d.embed_nocookie:d.embed_original,d.nocookie=e,b.setOverlay(h)}}}}),b.resolve()}),EasyBlog.module("composer/blocks/mobile",function(a){var b=this;EasyBlog.Controller("Composer.Blocks.Mobile",{defaultOptions:a.extend({"{blipp}":"[data-eb-blipp]","{viewport}":".eb-composer-viewport","{actionBar}":"[data-eb-composer-actions]"},EBD.selectors)},function(b,c,d,e,f){return{init:function(){f=b.blocks,e=f.composer
