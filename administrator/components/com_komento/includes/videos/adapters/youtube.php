...
class KomentoVideoYoutube
{
	...
	public function getEmbedHTML($url)
	{
		...
		if ($code) {
			return '<div class="embed-responsive embed-responsive-16by9" style="max-width:' . $width . 'px;"><iframe class="embed-responsive-item" title="YouTube video player" width="' . $width . '"  src="https://www.youtube.com/embed/' . $code . '?wmode=transparent" frameborder="0" allowfullscreen></iframe></div>';
		} else {
