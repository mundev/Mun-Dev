	...
	<div class="col-lg-6">
		<div class="panel">
			...
			<div class="panel-body">
				...
				<?php echo $this->html('settings.textbox', 'max_image_width', 'COM_KOMENTO_SETTINGS_LAYOUT_IMAGE_WIDTH', '', array('postfix' => 'COM_KOMENTO_PIXELS'), '', 'input-mini text-center'); ?>
				<?php echo $this->html('settings.textbox', 'max_image_height', 'COM_KOMENTO_SETTINGS_LAYOUT_IMAGE_HEIGHT', '', array('postfix' => 'COM_KOMENTO_PIXELS'), '', 'input-mini text-center'); ?>
				<?php echo $this->html('settings.textbox', 'bbcode_video_width', 'COM_KOMENTO_SETTINGS_LAYOUT_VIDEO_WIDTH', '', array('postfix' => 'COM_KOMENTO_PIXELS'), '', 'input-mini text-center'); ?>
			</div>
		</div>
	</div>
</div>
