		...
		<table class="app-table table" data-language-list>
			<thead>
				...
				<th width="10%" class="center">
					<?php echo $this->html('grid.sort', 'locale', JText::_('COM_KOMENTO_TABLE_COLUMN_LOCALE'), $ordering, $direction); ?>
				</th>
				<th width="15%" class="center">
					<?php echo $this->html('grid.sort', 'state', JText::_('COM_KOMENTO_TABLE_COLUMN_STATE'), $ordering, $direction); ?>
				</th>
				<th width="10%" class="center">
